  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-mono",
  {
    variants: {
      variant: {
        ...
        red: "border-transparent bg-red-500/20 text-red-400 border border-red-500/30",
        amber: "border-transparent bg-amber-500/20 text-amber-400 border border-amber-500/30",
        gray: "border-transparent bg-gray-500/20 text-gray-400 border border-gray-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
